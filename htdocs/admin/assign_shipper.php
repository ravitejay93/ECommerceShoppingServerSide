...
$result2 = mysqli_query($localhost,"INSERT INTO zip_table(zip_number_max,zip_number_min,state,sales_tax,shipper_id)
VALUES ('$max','$min','$state','$tax','$shipper')") or die(mysqli_error());
 if ($result2==true )
{
$response["success"] = 1;
