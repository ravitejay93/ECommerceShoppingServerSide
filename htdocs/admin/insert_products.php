...
$name_p=addslashes($_FILES['image']['name']);
...
$sql = "INSERT INTO product (product_name,product_id,unitprice,quantity,category_id,product_description,image)
VALUES ('$name','$id','$price','$quantity','$category_id','$description','$image')";
